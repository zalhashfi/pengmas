...
export const STRINGS = {
  id: {
    ...
    hero: {
      ...
      panelSubtitle: "Data masuk tiap 2 menit",
      panelLive: "LIVE",
      panelStale: "Data basi",
      panelEmpty: "Belum ada data",
      panelNote: "Angka di panel ini contoh tampilan, bukan pembacaan sensor.",
      trustNoLogin: "Tanpa login",
      trustRealtime: "Data real-time",
  ...
  en: {
    ...
    hero: {
      ...
      panelSubtitle: "Data arrives every 2 minutes",
      panelLive: "LIVE",
      panelStale: "Stale data",
      panelEmpty: "No data yet",
      panelNote: "The numbers in this panel are a layout sample, not a sensor reading.",
      trustNoLogin: "No login required",
      trustRealtime: "Real-time data",
      trustIot: "IoT based",
